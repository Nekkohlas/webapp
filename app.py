...
def list(id):
   ...
   #following if els return checks whether ?json has been appended to the url and will return a data structure
   #see https://hwrberlin.github.io/fswd/02-fswd-intro.html 5 - Bonus
    if request.args.get('json') is not None:
